...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://cinquemb.github.io/uniswap-interface/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://cinquemb.github.io/uniswap-interface/#/swap?inputCurrency=${
...
export function getMiningPoolLink(token0Address) {
  return `https://cinquemb.github.io/uniswap-interface/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://cinquemb.github.io/uniswap-interface/#/uni'
  if (!linkVariable) {
